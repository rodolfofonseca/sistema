<?php
require __DIR__.'/bancoDeDados/vendor/autoload.php';
use Kreait\Firebase\Factory;
use Kreait\Firebase\ServiceAccount;
$factory = (new Factory())->withServiceAccount(__DIR__.'/bancoDeDados/firebaseconfig.json')->withDatabaseUri('https://portaldenoticias-52a35-default-rtdb.firebaseio.com/');
